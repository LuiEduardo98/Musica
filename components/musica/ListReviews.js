...
import { getMusicaReviews } from '../../utils/actions'
import { size, map } from 'lodash'
import { useFocusEffect } from '@react-navigation/native'

moment.locale("es")

export default function ListReviews({ navigation, idMusica }) {
    ...
    useFocusEffect(
        useCallback(() => {
        (async() => {
            const response = await getMusicaReviews(idMusica)
        ...
        <View>
            {
                userLogged ? (
                    <Button
                        ...
                        onPress={() => navigation.navigate("add-review-musica", {idMusica})}
                        icon={{
            ...
            <View style={styles.imageAvatar}>
                <Avatar
                    ...
                    source={
                        avatarUser
                            ? { uri: avatarUser}
                            : require("../../assets/avatardefault.jpg")
                    }
                />
            </View>
